...
You can use Anaconda for easy install by importing certain environment file corresponding to target GPU,
taking example of RTX3070:
```
conda env create --file environment_RTX3070.yml
```

Alternatively, you can also compile from scratch (Below is tested for RTX3070)
```
$ conda create --name Pytorch-YoLo-test  python=3.6
$ conda activate Pytorch-YoLo-test
